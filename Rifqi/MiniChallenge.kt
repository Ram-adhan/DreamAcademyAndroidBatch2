...
fun tampilkanMenu(){
    println("-- Menampilkan Menu Makanan --")
    println()
    fun listMenu() : String {
...
fun pesan() {
    ...
    while (x < jmlpsn) {
        ...
        if (mkn == "Mie tante" || mkn == "mie tante") {
            ...
            println("Menu yang anda inputkan tidak tersedia")
            price = 0
        }
        x++;
        total = total + bayar
